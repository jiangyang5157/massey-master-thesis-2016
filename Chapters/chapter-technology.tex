...
\begin{figure}[H]
\caption{Global Smartphone Shipments Forecase \cite{tony.global-smartphone-market.2015}}
...
\begin{figure}[H]
\caption{Smartphone OS Market Share \cite{idc.smartphone-os-market-share.2016}}
...
Moreover, the perfect part is the Google VR SDK \cite{google.vr-sdk.2016} for Android supports and the affordable Cardboard product \cite{google.cardboard.2016} designed for different kind of mobile devices.
...
\begin{figure}[H]
\caption{KML schema \cite{google.kml.2016}}
