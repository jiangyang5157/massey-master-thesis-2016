...
%****************************************************************
\section{Geodetic datum}

Placemark
The Geodetic (Latitude / Longitude /  Altitude) coordinate system
The Earth-Centered, Earth-Fixed (ECEF) coordinate system
%https://en.wikipedia.org/wiki/Geodetic_datum

ECEF Datum
ECEF (earth-centered, earth-fixed), also known as ECR (earth-centered rotational), is a geographic coordinate system.
