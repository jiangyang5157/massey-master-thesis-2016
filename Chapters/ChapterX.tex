...
%****************************************************************
\section{Description Text Analysing}

Description of placemarker requires an appropriate analysis for display. The raw data of description string could be a normal text, an image URL, an URL returns different type of content, or maybe just some meaningless string.

The implementation of analysis in this project did not cover every situation, but it has a flexible and extendable functionality.
